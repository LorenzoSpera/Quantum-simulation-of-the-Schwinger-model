...
$$
H_W =\sum_{n=0}^{N-2} \bar{\phi}_n ( \tfrac{r+i\gamma^1}{2a} ) U_n \phi_{n+1} + \text{h.c.} + \sum_{n=0}^{N-1}(m_{\text{lat}}+\tfrac{r}{a})\bar{\phi}_n\phi_n+ \sum_{n=0}^{N-2} \tfrac{a g^2}{2}(L_n + \tfrac{\theta}{2\pi})^2
$$
